...
// ... (dentro de tu función addToCart(event) { ... })

            // 1. Lógica del Carrito (Guardar en localStorage)
            // ... (tu código getCart(), existingItem, cart.push, saveCart, updateCartCount) ...

            // 2. 🔥 ACTIVAR EL MODAL DE BOOTSTRAP AQUÍ 🔥
            const modalElement = document.getElementById('compraModal');
            const myModal = new bootstrap.Modal(modalElement);
            myModal.show();
            
            // 3. Animación visual de confirmación (Se queda después del modal)
...
// Asegúrate de que el script de Bootstrap esté cargado en tu HTML:
